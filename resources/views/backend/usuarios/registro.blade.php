        ...
        <div class="row justify-content-center">
            ...
            <div class="card shadow border-0 rounded-4">
                ...
                <form action="{{ url('/registro') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Tu nombre" value="{{ old('name') }}">
                            @error('name')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="apellido" class="form-control" placeholder="Tu apellido" value="{{ old('apellido') }}">
                            @error('apellido')
                                <small class="text-danger d-block mt-1">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" name="telefono" class="form-control" placeholder="Ej: 3794 123456" value="{{ old('telefono') }}">
                        @error('telefono')
                            <small class="text-danger d-block mt-1">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input" name="terminos" type="checkbox" id="terminos" {{ old('terminos') ? 'checked' : '' }}>
                ...
                <p class="text-center mt-4 mb-0">
                    ¿Ya tenés cuenta? <a href="{{ route('login') }}" class="text-decoration-none">Iniciar sesión</a>
                </p>
